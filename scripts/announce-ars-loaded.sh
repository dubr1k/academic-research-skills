...
Slash commands (21) — light modes pin sonnet in frontmatter; the three heavy modes inherit the session model (the v3.7.0 opus floor was retired in the 2026-06 harness pass):
  ...
  /ars-auto              inherit Route automatically between English and Russian academic workflows
  /ars-ru-research       inherit Russian-context research, source verification, and literature review
  /ars-ru-paper          inherit Russian-context paper planning, writing, revision, and ГОСТ formatting
  /ars-ru-reviewer       inherit Russian-context independent peer review and re-review
  /ars-ru-pipeline       inherit End-to-end bilingual/Russian academic pipeline
